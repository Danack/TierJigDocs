...
rm -f /etc/nginx/sites-enabled/tier.nginx.conf
rm -f /etc/php-fpm.d/${'app_name'}.php-fpm.conf
rm -f /etc/php-fpm.d/${'app_name'}.php.fpm.ini

ln -sfn ${'app_root_directory'}/autogen/nginx.jig.conf /etc/nginx/sites-enabled/${'app_name'}.nginx.conf
ln -sfn ${'app_root_directory'}/autogen/nginx.tier.conf /etc/nginx/sites-enabled/tier.nginx.conf
